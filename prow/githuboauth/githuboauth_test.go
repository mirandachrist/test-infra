...
func (c mockOAuthClient) WithFinalRedirectURL(url string) (OAuthClient, error) {
	return mockOAuthClient{&oauth2.Config{RedirectURL: "www.something.com" + url}}, nil
}
...
func TestHandleLogin(t *testing.T) {
	...
	for _, q := range strings.Split(path, "&") {
		if q == "redirect_uri=www.something.com%3Fdest%3Dwherever%3Frerun%3Dworking" {
			destCount++
		}
	}
	if destCount != 1 {
